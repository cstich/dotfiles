...
let
  dsfmtVersion = "2.2.3";
  dsfmt = fetchurl {
    url = builtins.trace "http://www.math.sci.hiroshima-u.ac.jp/~m-mat/MT/SFMT/dSFMT-src-${dsfmtVersion}.tar.gz"  "http://www.math.sci.hiroshima-u.ac.jp/~m-mat/MT/SFMT/dSFMT-src-${dsfmtVersion}.tar.gz";
    sha256 = "03kaqbjbi6viz0n33dk5jlf6ayxqlsq4804n7kwkndiga9s4hd42";
  };

  libuv = fetchurl {
    url = builtins.trace "https://api.github.com/repos/JuliaLang/libuv/tarball/${libuvVersion}" "https://api.github.com/repos/JuliaLang/libuv/tarball/${libuvVersion}";
    sha256 = libuvSha256;
  };

  rmathVersion = "0.1";
  rmath-julia = fetchurl {
    url = builtins.trace "https://api.github.com/repos/JuliaLang/Rmath-julia/tarball/v${rmathVersion}" "https://api.github.com/repos/JuliaLang/Rmath-julia/tarball/v${rmathVersion}";
    sha256 = "1qyps217175qhid46l8f5i1v8i82slgp23ia63x2hzxwfmx8617p";
  };

  virtualenvVersion = "16.7.9";
  virtualenv = fetchurl {
 url = builtins.trace "https://files.pythonhosted.org/packages/aa/3b/213c384c65e17995cccd0f2bb993b7b82c41f62e74c2f8f39c8e60549d86/virtualenv-16.7.9.tar.gz" "https://files.pythonhosted.org/packages/aa/3b/213c384c65e17995cccd0f2bb993b7b82c41f62e74c2f8f39c8e60549d86/virtualenv-16.7.9.tar.gz";
    sha256 = "1wwq4li2pkzsa44b46m4449l7l2lv70dl38xq5cjsd60hc4cfqhd";
  };

  libwhichVersion = "81e9723c0273d78493dc8c8ed570f68d9ce7e89e";
  libwhich = fetchurl {
    url = builtins.trace "https://api.github.com/repos/vtjnash/libwhich/tarball/${libwhichVersion}" "https://api.github.com/repos/vtjnash/libwhich/tarball/${libwhichVersion}";
    sha256 = "1p7zg31kpmpbmh1znrk1xrbd074agx13b9q4dcw8n2zrwwdlbz3b";
  };

  llvmVersion = "7.0.0";
#  llvm = fetchurl {
#    url = builtins.trace "http://releases.llvm.org/9.0.0/llvm-${llvmVersion}.src.tar.xz" "http://releases.llvm.org/9.0.0/llvm-${llvmVersion}.src.tar.xz";
#    sha256 = "117ymdz1by2nkfq1c2p9m4050dp848kbjbiv6nsfj8hzy9f5d86n";
#  };

  suitesparseVersion = "4.4.5";
  suitesparse = fetchurl {
    url = builtins.trace "http://faculty.cse.tamu.edu/davis/SuiteSparse/SuiteSparse-${suitesparseVersion}.tar.gz" "http://faculty.cse.tamu.edu/davis/SuiteSparse/SuiteSparse-${suitesparseVersion}.tar.gz";
...
stdenv.mkDerivation rec {
  ...
  inherit version;
   ...
   src = fetchzip {
     url = builtins.trace "https://github.com/JuliaLang/${pname}/releases/download/v${version}/${pname}-${version}.tar.gz" "https://github.com/JuliaLang/${pname}/releases/download/v${version}/${pname}-${version}.tar.gz";
     sha256 = src_sha256;
   };
  # src = fetchFromGitHub {
  #   owner = "JuliaLang";
  ...
  patches = builtins.trace [./use-system-utf8proc-julia-1.3.patch] [
